 ...
 * This file demonstrates how to integrate Gazeapex with a web frontend
 */

// For React/Vue/Angular applications
export class GazeapexClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new GazeapexClient(provider, contractAddress);
